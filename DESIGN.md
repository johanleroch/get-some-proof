...
- `Spot illustrations`: thin-line drawings for empty states, onboarding, the
  ...
  a proof stamp (and the same envelope on its way, speed lines trailing, for
  the moment an email has just gone out), a wall of framed Testimonials. They share one grammar,
