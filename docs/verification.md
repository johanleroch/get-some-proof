...
| Invitation hashing, matching verified email, rotation, expiry, delivery state, and provider neutrality | `tests/invitations.test.ts`; provider architecture documentation                                             |
