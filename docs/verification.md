...
| Pro text, video, and attribution capability boundaries                                                                             | `tests/collection-quotas.test.ts`; `tests/video-media.test.ts`; `tests/wall-customization.test.ts`                                           |
...
| Separate Archive/Permanent Deletion, concise confirmation, total erasure, retries, and quotas                                      | `tests/testimonial-moderation.test.ts`; `tests/video-media.test.ts`; `testimonial-inbox.test.tsx`; canonical deletion dialog visual evidence |
...
| Marketing site, blog, runtime custom roles, and full i18n excluded                                                                 | Recorded in `docs/product-scope.md`; no implementation required for v1                                                                       |
