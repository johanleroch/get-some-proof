...
Keep the original text, author name, role, company, individual rating and portrait when explicitly present. For each text testimonial, identify its most impactful phrase or short phrases and mark those exact original words as highlighted spans in richText. Keep highlights selective; do not rewrite the words or highlight the entire testimonial. Preserve source URLs and stable source identities. Do not rewrite, invent missing information, use an aggregate rating, or substitute a video thumbnail for a portrait.
...
For video, supply a public URL that points to the actual video file, or a public Mux HLS playback URL in the form https://stream.mux.com/{PLAYBACK_ID}.m3u8. Each video must be at most 10 minutes and 512 MB. Photos and videos are copied in the background. A page URL is not a video URL.
